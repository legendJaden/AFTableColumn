  ...
  <div id="app">
    <el-tabs v-model="activeNames" type="border-card">
      ...
      <el-tab-pane label="部分自适应" name="part-fit">
        <div class="el-table">设置 <code>&lt;el-table :fitAll="false"&gt;</code>后, 设置 <code>&lt;table-column fit&gt;</code> 者自适应</div>
        <PartFit></PartFit>
      </el-tab-pane>
    </el-tabs>
  </div>
...
import PartFit from './views/PartFit'
import PartNotFit from './views/PartNotFit'
export default {
  name: 'app',
  components: {
    AllFit,
